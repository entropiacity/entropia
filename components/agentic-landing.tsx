    ...
    <div className="bg-[#F5F4F0] text-[#111] min-h-screen font-sans antialiased">
      ...
      <section id="platform" className="py-32 px-6 md:px-12 lg:px-20">
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            ...
            <div className="mt-4"><Tag>PRODUCTS</Tag></div>
          ...
          <div className="grid grid-cols-12 grid-rows-auto gap-3" onMouseMove={handleMouse}>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={120}>
              ...
              <h3 className="text-lg font-light mb-2">Face Scan HRMS</h3>
              <p className="text-sm text-black/45 leading-relaxed">No buddy punching. No manual logs. Check-in in under a second, attendance marked automatically.</p>
            </BentoCard>
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-16">
            <div>
              ...
              <RevealText className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
                {"Two products.\nOne mission: replace the giants."}
              </RevealText>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <div className="mt-10 flex items-end gap-2">
                <LiveAgentCounter />
                <span className="text-black/30 text-sm mb-1 tracking-wide">events flowing today</span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3" onMouseMove={handleMouse}>
            {[
              ...
              },
              {
                ...
                price: "Talk",
                period: "",
                sub: "Chains & multi-outlet ops",
                features: ["Everything in both products", "Custom rollout plan", "Dedicated onboarding", "Priority support SLA", "White-label options", "Unlimited locations"],
                delay: 140,
                href: BOOK_DEMO_URL,
                cta: "BOOK DEMO",
              },
      ...
      <footer className="py-10 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <span className="font-pixel text-xs tracking-[0.25em] text-black/50">ENTROPIA</span>
          ...
          <div className="flex flex-wrap items-center gap-x-8 gap-y-3">
            {[
              ...
              { label: "Book demo",    href: BOOK_DEMO_URL },
            ].map(l => (
        ...
        <div className="max-w-6xl mx-auto mt-8 pt-6 border-t border-black/[0.04]">
          <span className="text-xs text-black/20">© 2026 Entropia Technologies Pvt. Ltd. Software built to replace the giants.</span>
        </div>
      </footer>
    </div>
  )
