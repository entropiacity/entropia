...
const STEPS = [
  {
    num: "01",
    title: "Book a demo",
    desc: "15 minutes. Real product. No pitch.",
    file: "demo-walkthrough",
    lang: "bash",
    code: [
      { type: "comment", text: "# See Entropia on your real use case" },
      { type: "command", text: "book --product kiosk|hrms" },
      { type: "gap" },
      { type: "comment", text: "# What you get in the call" },
      { type: "output", text: "✓ Live kiosk + PetPooja flow" },
      { type: "output", text: "✓ Face scan → payroll walkthrough" },
      { type: "output", text: "✓ Pricing for your outlet count" },
    ],
  },
  {
    num: "02",
    ...
    code: [
      ...
      { type: "plain", text: "});" },
      { type: "gap" },
      { type: "output", text: "✓ Zero downtime · zero data loss" },
    ],
  },
  {
    num: "03",
    title: "Train your team",
    desc: "Onboarding included, not upsold",
    file: "onboarding",
    lang: "bash",
    code: [
      { type: "comment", text: "# Same week you're ready to run" },
      { type: "command", text: "entropia onboard --team floor+hr" },
      { type: "gap" },
      { type: "output", text: "  Kiosk flow training…" },
      { type: "output", text: "  Face-scan stations live…" },
      { type: "output", text: "  Payroll formulas verified…" },
      { type: "gap" },
      { type: "success", text: "✓ Team ready in under a week" },
    ],
  },
  {
    num: "04",
    title: "Go live",
    desc: "Cut costs from day one",
    file: "go-live",
    lang: "bash",
    code: [
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-16">
          ...
          <h2 className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
            Kill the old stack.<br />Go live this week.
          </h2>
        </div>
