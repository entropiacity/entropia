...
const PRODUCTS = [
  {
    ...
    desc: "Branded kiosk flow with PetPooja sync and Razorpay at checkout. Orders hit the kitchen instantly — no tablet chaos, no counter bottlenecks.",
    stats: [{ v: "30x", l: "cheaper than UEngage" }, { v: "Days", l: "to go live" }],
    img: "/kiosk.png",
  },
  {
    label: "PETPOOJA",
    title: "Native POS sync. Zero double entry.",
    desc: "Two-way menu sync, modifiers mapped, order status in real time. Your PetPooja kitchen keeps running exactly as it does today.",
  ...
  },
  {
    ...
    desc: "Employees check in with a face scan. Attendance marks itself. Salary formulas run live. EPF, ESIC & TDS file without spreadsheets.",
    stats: [{ v: "70%", l: "vs PagarBook" }, { v: "1-click", l: "payroll run" }],
    img: "/hrms.png",
  },
  {
    label: "PAYROLL",
    title: "Custom formulas. Multi-branch command.",
    desc: "Basic, HRA, overtime, incentives — your rules, live. Every outlet on one dashboard. Replace PagarBook without the enterprise bloat.",
