    ...
    >
      <nav
        className={`relative z-50 mx-auto transition-all duration-500 ${
          isScrolled || isMobileMenuOpen
            ? "bg-background/80 backdrop-blur-xl rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.08)] max-w-[1200px]"
            : "bg-transparent rounded-none shadow-none max-w-[1400px]"
        }`}
      >
        <div
      ...
      >
        <div className="flex flex-col h-full px-8 pt-28 pb-8">
          ...
          >
            <a href="mailto:hello@entropiacity.com" className="flex-1" onClick={() => setIsMobileMenuOpen(false)}>
              <Button
                variant="outline"
            ...
            <Link href={BOOK_DEMO_URL} className="flex-1" onClick={() => setIsMobileMenuOpen(false)}>
              <Button
